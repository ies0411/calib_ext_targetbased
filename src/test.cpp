...
int main(int argc, char **argv) {
    ...
    ROS_INFO("main finish");

    // nh = n;
    // camera_in_topic = readParam<std::string>(nh, "camera_in_topic");
    // lidar_in_topic = readParam<std::string>(nh, "lidar_in_topic");

    message_filters::Subscriber<sensor_msgs::PointCloud2> cloud_sub(nh, "velodyne_points", 100);
    message_filters::Subscriber<sensor_msgs::Image> image_sub(nh, "/pylon_camera_node/image_raw", 100);
    message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(1000), cloud_sub, image_sub);
    ...
    min_points_on_plane = 250;
    num_views = 5;
    // num_views = readParam<int>(nh, "num_views");
    // no_of_initializations
    ...
    initializations_file = "/home/catkin_ws/src/cam_lidar_calib/debug_data/init.txt";
    ...
    result_str = "/home/catkin_ws/src/cam_lidar_calib/debug_data/CTL.txt";
    result_rpy = "/home/catkin_ws/src/cam_lidar_calib/debug_data/rpy.txt";

    // cam_config_file_path = readParam<std::string>(nh, "cam_config_file_path");
    ROS_INFO("2");
    cam_config_file_path = "/home/catkin_ws/src/cam_lidar_calib/config/basler.yaml";
